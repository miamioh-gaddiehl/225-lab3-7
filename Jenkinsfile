pipeline {
    ...
    environment {
        ...
        DOCKER_IMAGE = 'cithit/gaddiehl'                                                                    //<------your MiamiID
        IMAGE_TAG = "build-${BUILD_NUMBER}"
        GITHUB_URL = 'https://github.com/miamioh-gaddiehl/225-lab3-7.git'                                    //<------your MiamiID
        KUBECONFIG = credentials('gaddiehl-225')                                                         //<------your MiamiID
    }
         ...
         stage("Run Acceptance Tests") {
            steps {
                script {
                    ...
                    sh 'kubectl run qa-tests --image=qa-tests --restart=Never --rm --attach'
        ...
        stage ("Run Security Checks") {
            steps {
                ...
                sh '''
                    ...
                    -e BURP_START_URL=http://10.48.10.133 \
